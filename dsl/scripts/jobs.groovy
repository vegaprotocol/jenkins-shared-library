...
def approbationParams(def config=[:]) {
    return {
        ...
        if (config.type == 'core') {
            ...
            stringParam('TESTS_ARG', '{frontend-monorepo/apps/*-e2e/**/*.cy.{ts,js,tsx,jsx},vegawallet-desktop/frontend/automation/**/*.test.{ts,js,tsx,jsx},vegawallet-ui/apps/wallet-mock/src/test/**/*.test.{ts,js,tsx,jsx}}', '--tests argument value')
        }
