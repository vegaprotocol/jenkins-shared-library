...
def jobs = [
    ...
    [
        ...
        parameters: {
            ...
            booleanParam('BUILD_VEGA', true, 'Decide if VEGA_VERSION is to be build or downloaded')
    ...
    [
        ...
        parameters: {
            ...
            booleanParam('DEPLOY_CONFIG', true, 'Deploy some Vega Network config, e.g. genesis file')
            booleanParam('BUILD_VEGA', false, 'Decide if VEGA_VERSION is to be build or downloaded')
