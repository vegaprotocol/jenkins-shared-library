                    ...
                    stage('Self delegate') {
                        steps {
                            script {
                                ...
                                // convert from array of chars to array of lines by writing to file
                                writeFile(
                                    file: 'tmp.txt',
                                    text: stdout,
                                )
                                ...
                                NEW_VALIDATOR_PUBLIC_KEY = stdout.find{ line -> line.contains('VegaPubKey')}.split(':')[-1].replaceAll('"', '').replaceAll('}', '')
                            }
                        }
                    }
